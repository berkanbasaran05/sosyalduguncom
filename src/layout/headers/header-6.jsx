    ...
    <React.Fragment>
      <header className="d-none d-lg-block">
        <div id="header-sticky" className={`tp-header-area-two tp-header-bg header-transparent header-transparent-two ${headerSticky ? 'header-sticky' : ''}`}>
          <div className="header-six-container">
                  ...
                  <ul className="d-none d-xxl-block">
                    {!user?.email && <li>
                      <Link href="https://portal.sosyaldugun.com/">
                        <a><i className="far fa-user fa-user"></i> Giriş Yap</a>
                      </Link>
                    </li>}
                    {user?.email && <li>
                        <button onClick={logout} style={{cursor:'pointer'}}>
                          <a><i className="far fa-user fa-user"></i>Çıkış Yap</a>
                        </button>
                    </li>}
                    <li><a href="#">TR<i className="fal fa-arrow-down arrow-down"></i></a>
                      <Languages />
                    </li>
                  </ul>
                  <div className="tp-header-yellow-button">
                    <Link href="/about">
                      <a className="tp-btn-white">Nasıl Çalışır</a>
                    </Link>
                  </div>
                </div>
              </div>
      ...
      {/* <!-- mobile-menu-area --> */}
      <MobileMenu logo={"logosd.png"} transparent={false} />
