...
const footer_contents = {
  title: <>Bir çok çalışma ortağımızla <br /> işinizi kolayalaştırıyoruz.🤝</>,
  btn_text: 'Birlikte Çalışalım',
  copyRight_text: <>© {new Date().getFullYear()} SosyalDugun , Tüm Haklar Saklıdır.</>,
  conditions: ['Destek', 'Gizlilik Politakası', 'Şartlar ve Koşullar  '],
