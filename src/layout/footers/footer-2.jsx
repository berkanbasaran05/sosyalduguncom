...
const footer_contents = {
  ...
  title: 'Birlikte unutulmaz düğün deneyimleri yaratmaya hazır mısınız?',
  text: 'SosyalDüğün olarak, düğünlerinizde uzaktan canlı yayın özelliği sunan ve otomasyon sistemi ile mükemmel bir deneyim yaşatan uzmanız. Eşsiz düğün organizasyonları için buradayız.',
  btn_text: 'Bize ulaşın',
  copy_right_text: <>© {new Date().getFullYear()} SosyalDugun , Tüm Hakları Saklıdır.</>,
  copy_right_menu: ['Gizlilik Sözleşmesi', 'KVKK'],
  social_links: [
